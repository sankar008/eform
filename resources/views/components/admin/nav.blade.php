 ...
 <aside class="app-sidebar">
					...
					<ul class="side-menu">
						...
						<li class="slide">
							<a class="side-menu__item"  href="{{ URL::to('admin/category') }}"><i class="side-menu__icon fa fa-cube"></i><span class="side-menu__label">Categary</span><span class="badge badge-orange nav-badge"></span></a>
							<ul class="slide-menu">
							</ul>
						</li>

						<li class="slide">
							<a class="side-menu__item"  href="{{ URL::to('admin/subcategory') }}"><i class="side-menu__icon fa fa-cube"></i><span class="side-menu__label">Sub Categary</span><span class="badge badge-orange nav-badge"></span></a>
							<ul class="slide-menu">
							</ul>
						</li>
